...
execute as @a[scores={combsnap.food=6..18,combsnap.health=1..,combsnap.cooldown=0},tag=!combsnap.off,gamemode=!creative,gamemode=!spectator] if score @s combsnap.maxhealth > @s combsnap.health run function combsnap:health
# golfed

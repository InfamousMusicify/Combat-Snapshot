...
tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
##### tellraw @s ["",{"text":"[ ✎ ]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set #cooldown combsnap.config "},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enter the number of seconds between health regen. (# in seconds +1)","color":"gray"},{"text":"\nAccepts: whole numbers 1+\nDefault: 4","color":"dark_gray"}]}}," Heal Increment ",{"text":"(Current: ","color":"gray"},{"score":{"name":"#cooldown","objective":"combsnap.config"},"color":"gray"},{"text":")","color":"gray"}]
tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}

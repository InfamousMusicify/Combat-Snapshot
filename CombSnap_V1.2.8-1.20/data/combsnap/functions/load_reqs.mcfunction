...
# setup (snapshot 8 = 2 second regen_rate, Jebs preset, 1)
...
execute unless score #strength_potion combsnap.config matches 0.. run scoreboard players set #strength_potion combsnap.config 0

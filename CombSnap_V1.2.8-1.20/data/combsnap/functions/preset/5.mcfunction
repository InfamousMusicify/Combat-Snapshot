#Infamous preset - infinite sprinting until starve, no dmg mods
scoreboard players set #faster_combat combsnap.config 1
...
scoreboard players set #sprint combsnap.config 1
